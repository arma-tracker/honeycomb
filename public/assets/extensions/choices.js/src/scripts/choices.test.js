    ...
    describe('constructor', () => {
        ...
        `;
            ...
            describe('when an element cannot be found in the DOM', () => {
                it('throws an error', () => {
                    document.body.innerHTML = ``;
                    expect(() => new Choices()).to.throw(TypeError, 'Expected one of the following types text|select-one|select-multiple');
                });
            });
        });
        describe('passing an element', () => {
          ...
          `;
                    expect(() => new Choices('[data-choice]')).to.throw(TypeError, 'Expected one of the following types text|select-one|select-multiple');
                });
            });
        });
    });
        ...
        describe('_getTemplate', () => {
            describe('when passing a template key', () => {
                it('returns the generated template for the given template key', () => {
                    ...
                    expect(instance._templates[templateKey]).to.have.been.calledOnceWith(instance.config.classNames, customArg);
                });
            });
        });
        describe('_onKeyDown', () => {
        ...
        describe('_removeItem', () => {
            ...
            describe('when given an item to remove', () => {
                ...
                it('triggers a REMOVE_ITEM event on the passed element', (done) => {
                    passedElement.addEventListener('removeItem', (event) => {
