...
const templates = {
    ...
    item({ item, button, highlightedState, itemSelectable, placeholder, }, { id, value, label, customProperties, active, disabled, highlighted, placeholder: isPlaceholder, }, removeItemButton) {
        const div = Object.assign(document.createElement('div'), {
            className: item,
            innerHTML: label,
        });
    ...
    choice({ item, itemChoice, itemSelectable, selectedState, itemDisabled, placeholder, }, { id, value, label, groupId, elementId, disabled: isDisabled, selected: isSelected, placeholder: isPlaceholder, }, selectText) {
        const div = Object.assign(document.createElement('div'), {
            id: elementId,
            innerHTML: label,
