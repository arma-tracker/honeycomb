...
describe('components/input', () => {
    ...
    describe('addEventListeners', () => {
        ...
        it('adds event listeners', () => {
            ...
            expect(['input', 'paste', 'focus', 'blur']).to.have.members(Array.from({ length: addEventListenerStub.callCount }, (_, i) => addEventListenerStub.getCall(i).args[0]));
        });
    });
    ...
    */
    ...
    describe('value getter', () => {
        ...
        it('strips HTML from value', () => {
            ...
            instance.element.value = value;
            expect(instance.value).to.equal('&lt;script&rt;somethingMalicious();&lt;/script&rt;');
        });
    });
