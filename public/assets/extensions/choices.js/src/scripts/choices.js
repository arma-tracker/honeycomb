...
import { activateChoices, addChoice, clearChoices, filterChoices, } from './actions/choices';
...
import { diff, existsInArray, generateId, getAdjacentEl, getType, isScrolledIntoView, isType, sortByScore, strToEl, } from './lib/utils';
...
class Choices {
    ...
    constructor(element = '[data-choice]', userConfig = {}) {
        this.config = merge.all([DEFAULT_CONFIG, Choices.defaults.options, userConfig], 
