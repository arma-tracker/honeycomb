...
import { getRandomNumber, generateChars, generateId, getType, isType, sanitise, sortByAlpha, sortByScore, existsInArray, cloneObject, dispatchEvent, diff, } from './utils';
describe('utils', () => {
    ...
    describe('sanitise', () => {
        ...
        describe('when passing a string', () => {
            it('strips HTML from value', () => {
                ...
                const output = sanitise(value);
                expect(output).to.equal('&lt;script&rt;somethingMalicious();&lt;/script&rt;');
            });
        });
    });
